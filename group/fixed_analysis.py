...
colname2 = [ ['女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比','女性佔比',
 '總人數','總人數','總人數','總人數','總人數','總人數','總人數','總人數','總人數','總人數','總人數','總人數','總人數','總人數','總人數',],
 ['初階管理職','初階管理職','初階管理職','初階管理職','初階管理職','中階管理職','中階管理職','中階管理職','中階管理職','中階管理職','高階管理職','高階管理職','高階管理職','高階管理職','高階管理職',
 '初階管理職','初階管理職','初階管理職','初階管理職','初階管理職','中階管理職','中階管理職','中階管理職','中階管理職','中階管理職','高階管理職','高階管理職','高階管理職','高階管理職','高階管理職'],
...
for i in range(9):
    seniority[i].to_csv(str(i+1)+'.'+theme[i]+'服務年資.csv',encoding='utf_8_sig')
    management_seniority[i].to_csv(str(i+1)+'.'+theme[i]+'管理職服務年資.csv',encoding='utf_8_sig')
    management[i].to_csv(str(i+1)+'.'+theme[i]+'各階管理職人數.csv',encoding='utf_8_sig')
