...
df = statData[['2.單位總員工人數','土木營建領域專長 男性 專任 人數','建築、都市規劃領域專長 男性 專任 人數','電子電機領域專長 男性 專任 人數','資訊通訊領域專長 男性 專任 人數','化工材料領域專長 男性 專任 人數',
 '生技醫工領域專長 男性 專任 人數','環工綠能領域專長 男性 專任 人數','機械領域專長 男性 專任 人數','其他領域專長 男性 專任 人數','非工程與科技領域專長 男性 專任 人數',
 '土木營建領域專長 女性 專任 人數','建築、都市規劃領域專長 女性 專任 人數','電子電機領域專長 女性 專任 人數','資訊通訊領域專長 女性 專任 人數','化工材料領域專長 女性 專任 人數',
 '生技醫工領域專長 女性 專任 人數','環工綠能領域專長 女性 專任 人數','機械領域專長 女性 專任 人數','其他領域專長 女性 專任 人數','非工程與科技領域專長 女性 專任 人數']]
...
result1 = pd.DataFrame(columns=['土木營建','建築、都市規劃','電子電機','資訊通訊','化工材料','生技醫工','環工綠能','機械','其他','非工程領域',
         '土木營建','建築、都市規劃','電子電機','資訊通訊','化工材料','生技醫工','環工綠能','機械','其他','非工程領域'])
for n in range(4):
    temp = [ result[result.columns[i]][n]+result[result.columns[i+10]][n] for i in range(10) ]
    temp1 = [ str(round((result[result.columns[i+10]][n]/temp[i])*100,1))+'%' for i in range(10) ]
    result1.loc[num[n]]=temp+temp1

col = [ ['各領域人數','各領域人數','各領域人數','各領域人數','各領域人數','各領域人數','各領域人數','各領域人數','各領域人數','各領域人數',
         '各領域女性佔比','各領域女性佔比','各領域女性佔比','各領域女性佔比','各領域女性佔比','各領域女性佔比','各領域女性佔比','各領域女性佔比','各領域女性佔比','各領域女性佔比',],
        ['土木營建','建築、都市規劃','電子電機','資訊通訊','化工材料','生技醫工','環工綠能','機械','其他','非工程領域',
         '土木營建','建築、都市規劃','電子電機','資訊通訊','化工材料','生技醫工','環工綠能','機械','其他','非工程領域'] ]
...
r1.columns=['男性','女性']
sumList = [ r1.loc[num[i]].sum() for i in range(4)]
rateList = [ str(round((r1['女性'][i]/sumList[i])*100,1))+'%' for i in range(4) ]
r1['合計']=sumList
r1['女性佔比']=rateList
