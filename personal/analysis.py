...
ct1 = ct1.rename(index={'公司組織調整（例如裁撤、縮編或退出本地市場）':'公司組織調整','All':'人數'},columns={'All':'小計'})
ct1.columns.name='性別'
...
ct1.index.name = '在您或您認識的工程與科技領域女性身上，性別在求職時的職務選擇方面有否差異？(%d人)'%(num)
ct1.columns.name = '性別'
temp = list(ct1.index)
...
name = ['年齡','最高學歷','最高學歷(比例)','總年資','離開工程職務最主要原因分析','目前工作狀況','對於現任職務之五年後職涯發展的預期','預期的職涯發展需要哪些配合因素來達成',
